...
setwd("../../../mturk/mp-game-2/")

#output_fig_path <- "~/Documents/dissertation/proposal/"

data_1 <- read.delim("logScores/2017-9-28-23h-20m-42s-4437-0f3b8d69-8b75-48e9-b408-b75d41725443.csv", header=TRUE)
data_2 <- read.delim("logTest/2017-9-28-23h-20m-42s-4437-0f3b8d69-8b75-48e9-b408-b75d41725443.csv", header=TRUE)
data_3 <- read.delim("logTrain/2017-9-28-23h-19m-25s-4437-0f3b8d69-8b75-48e9-b408-b75d41725443.csv", header=TRUE)
View(data_1)
View(data_2)
View(data_3)
...
test_data <- read.delim("../../data/mp-game-2/logTest/2017-10-3-8h-1m-20s-3950-67e1dc62-2b5c-4896-9801-61472047e53a.csv", header = T)
