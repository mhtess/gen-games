...
#### Rational Rules Analysis
```{r}
setwd("~/Desktop/Research/Cultural_Evolution/gen-games/r_data_analysis/Game_5_Pilot_5_02_05")
hard_rule_stimuli <- fromJSON(file="./hard_rule_data.json")
rr_predictives <- webppl(program_file = "/Users/Sahil/Desktop/Research/Cultural_Evolution/gen-games/r_data_analysis/Game_5_Pilot_5_02_05/rational_rules.wppl", data = hard_rule_stimuli, data_var="data")
rr_predictives <- as.data.frame(rr_predictives)




# rs %>%  # rs is posterior predictive distribution
#   group_by(Parameter) %>%
#   summarize(isWuggy = mean(value)) %>%
#   ungroup() %>%
#   separate(Parameter, into = c("critter", "color", "size", "correctLabel"))
