...
### Rational Rules
```{r}
jsonlite::toJSON(summary_data_reduced$testing_summary_stats)

results <- webppl(program_file = "./rational_rules.wppl", packages=c("webppl-json"), data=summary_data_reduced$testing_summary_stats, data_var="humanData")
