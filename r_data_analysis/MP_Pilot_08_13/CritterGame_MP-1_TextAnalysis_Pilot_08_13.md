...
| distribution      | dyad    |  trial| player  | messages                                                                                                                                                                                                                                                                       |  totalCorrect|   hit|    CR|
|:------------------|:--------|------:|:--------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------:|-----:|-----:|
...
| distribution      | accuracyBin | dyad    |  trial| player  | messages                                                                                                                                                                                                                                                                       |  totalCorrect|   hit|    CR|
|:------------------|:------------|:--------|------:|:--------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------:|-----:|-----:|
...
conditionals <- tokenized %>% filter(lemma %in% conditional_words) %>% group_by(lemma) %>% 
    summarize(n = sum(n))

conditional_count <- ggplot(conditionals, aes(x = lemma, y = n)) + geom_bar(stat = "identity", 
    fill = "black") + scale_x_discrete("Word Used in Response", limits = c(conditional_words)) + 
    scale_y_continuous("Frequency", limits = c(0, 2)) + ggtitle("Conditionals") + 
...
![](CritterGame_MP-1_TextAnalysis_Pilot_08_13_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-22-1.png)

Total Word Count by Dependencies
================================

![](CritterGame_MP-1_TextAnalysis_Pilot_08_13_files/figure-markdown_github-ascii_identifiers/unnamed-chunk-23-1.png)
