...
text_byPartnerScore <- text_df %>%
  select(gameid_num, trialNum, distribution, text, partnerPercentCorrectlyHit, partnerPercentCorrectlyRejected, partnerPercentCorrect) %>%
  arrange(desc(partnerPercentCorrect))
