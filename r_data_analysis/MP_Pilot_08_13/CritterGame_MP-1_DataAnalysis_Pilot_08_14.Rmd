...
graph_distribution_gameID <- ggplot(distribution_gameID, aes(x=gameid_num, y=percentCorrect)) +
  geom_bar(stat="identity",  position="dodge") +
  scale_x_discrete("Trial Number") +
    geom_hline(yintercept = 0.5, lty = 3)+
  scale_fill_manual("PercentCorrect") +
  facet_wrap(~distribution) +
  ggtitle("Test Accuracy by Distribution and Dyad") +
  theme_minimal() +
  theme(plot.title = element_text(hjust=0.5, size=18, face="bold"),
        axis.text.x = element_text(angle = 90 ))
graph_distribution_gameID
```
