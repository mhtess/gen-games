...
while (i<exemplarN) {
	allCreatures.push({
		...
		"prop1": wugOpts.height == null ? Ecosystem.randProp() : wugOpts.height,
		"prop2": wugOpts.fatness == null ? Ecosystem.randProp() : wugOpts.fatness,
...
while (i<2*exemplarN) {
	allCreatures.push({
		...
		"prop1": blicketOpts.height == null ? Ecosystem.randProp() : blicketOpts.height,
		"prop2": blicketOpts.fatness == null ? Ecosystem.randProp() : blicketOpts.fatness,
...
while (i<3*exemplarN) {
	allCreatures.push({
		...
		"prop1": ramboOpts.height == null ? Ecosystem.randProp() : ramboOpts.height,
		"prop2": ramboOpts.fatness == null ? Ecosystem.randProp() : ramboOpts.fatness,
